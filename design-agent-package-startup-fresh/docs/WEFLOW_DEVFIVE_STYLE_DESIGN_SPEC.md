...
- hero asset: `assets/weflow-devfive-hero.png`
...
- `assets/weflow-devfive-service-workflow.png`
...
- `assets/weflow-devfive-proof-board.png`
...
- CTA 이미지:
  - `assets/weflow-devfive-consultation.png`
- 플로팅 캐릭터:
...
- `assets/weflow-devfive-hero.png`
- `assets/weflow-devfive-service-workflow.png`
- `assets/weflow-devfive-proof-board.png`
- `assets/weflow-devfive-consultation.png`
...
- hero visual: assets/weflow-devfive-hero.png
- service workflow: assets/weflow-devfive-service-workflow.png
- proof board: assets/weflow-devfive-proof-board.png
- consultation visual: assets/weflow-devfive-consultation.png
